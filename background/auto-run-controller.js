        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              cloudflareTempEmailBaseUrl: prevState.cloudflareTempEmailBaseUrl,
              cloudflareTempEmailAdminAuth: prevState.cloudflareTempEmailAdminAuth,
              cloudflareTempEmailCustomAuth: prevState.cloudflareTempEmailCustomAuth,
              cloudflareTempEmailReceiveMailbox: prevState.cloudflareTempEmailReceiveMailbox,
              cloudflareTempEmailUseRandomSubdomain: prevState.cloudflareTempEmailUseRandomSubdomain,
              cloudflareTempEmailCustomSubdomainPrefix: prevState.cloudflareTempEmailCustomSubdomainPrefix,
              cloudflareTempEmailDomain: prevState.cloudflareTempEmailDomain,
